...
// TODO: Test_convertNetworkConfig
//
//func Test_convertRuntimePlatform(t *testing.T) {
//	testCases := map[string]struct {
//		inPlatform *manifest.PlatformConfig
//		wanted     *template.RuntimePlatformOpts
//	}{
//		"nothing specified": {
//			inPlatform: nil,
//			wanted: &template.RuntimePlatformOpts{
...
//			},
//		},
//		"a different (valid) OS/Arch specified": {
//			inPlatform: &manifest.PlatformConfig{
//				OS:   "SomeValidOS",
//				Arch: "12345",
//			},
...
//	for name, tc := range testCases {
//		t.Run(name, func(t *testing.T) {
//			got := convertRuntimePlatform(tc.inPlatform)
//			require.Equal(t, tc.wanted, got)
//		})
//	}
//}
